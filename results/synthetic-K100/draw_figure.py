...
# 整合约束违反度数据
aggregate_violations(cases_to_plot, 'results/synthetic-K100', 'nnLASSO-violations-summary.csv')

# 调用函数绘制图形
plot_shifted_losses_from_cases(cases_to_plot, 'results/synthetic-K100', 'synthetic-K100_loss.png')