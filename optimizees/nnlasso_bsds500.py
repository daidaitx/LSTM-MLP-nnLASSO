...
Then you may find 1000 nnLASSO instances in "./matdata/nnlasso-real/"
...
generated_data_pth = './optimizees/matdata/nnlasso-real/'
...
## Process the dictionary and generate 1000 nnLASSO instances for testing
